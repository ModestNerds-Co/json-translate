...
export function TranslationProgress({
  ...
  const getStatusIcon = (status: TranslationProgressItem['status']) => {
    switch (status) {
      case 'pending':
        return '⏳'
      case 'translating':
        return React.createElement(Spinner, { size: "sm", className: "inline-block" })
      case 'completed':
        return '✅'
      case 'error':
        return '❌'
  ...
  const getStatusText = () => {
    if (isCompleted) {
      return hasErrors ? 'Completed with errors' : 'Translation completed successfully'
    }
    if (isTranslating) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          null,
          React.createElement(CardTitle, { className: "text-lg" }, "Translation Progress"),
          React.createElement(CardDescription, null, getStatusText())
        ),
        React.createElement(
          "div",
          { className: "flex items-center gap-2" },
          !hasStarted && totalItems > 0 && React.createElement(
            Button,
            {
              onClick: onStart,
          ...
          isTranslating && React.createElement(
            Button,
            {
              onClick: onPause,
              variant: "outline",
          ...
          hasStarted && !isTranslating && !isCompleted && React.createElement(
            Button,
            {
              onClick: onResume,
              variant: "outline",
          ...
          hasStarted && !isCompleted && React.createElement(
            Button,
            {
              onClick: onStop,
              variant: "destructive",
    ...
    React.createElement(
      ...
      // Progress bar
      totalItems > 0 && React.createElement(
        "div",
        { className: "space-y-2" },
        ...
        React.createElement(
          ...
          React.createElement("span", null, `${completedItems} of ${totalItems} completed`),
      ...
      totalItems > 0 && React.createElement(
        ...
        completedItems > 0 && React.createElement(
          Badge,
          { variant: "success" },
          `${completedItems} completed`
        ),
        errorItems > 0 && React.createElement(
          Badge,
          { variant: "destructive" },
          `${errorItems} errors`
        ),
        pendingItems > 0 && React.createElement(
          Badge,
          { variant: "outline" },
      ...
      // Current item
      isTranslating && currentItem && React.createElement(
        Alert,
        null,
        React.createElement(
          AlertDescription,
          ...
          React.createElement("span", { className: "font-medium" }, "Translating:"),
          React.createElement("code", { className: "text-sm" }, currentItem.key)
        )
      ),
      ...
      showDetails && totalItems > 0 && totalItems <= 20 && React.createElement(
        "div",
        { className: "space-y-2" },
        React.createElement(
          "h4",
        ...
        React.createElement(
          ...
          items.map((item, index) =>
            React.createElement(
              ...
              item.status === 'error' && item.error && React.createElement(
                "span",
      ...
      showDetails && totalItems > 20 && React.createElement(
        "div",

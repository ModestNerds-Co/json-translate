  ...
  head: () => ({
    meta: [
      ...
      ...seo({
        ...
        description: "AI-powered JSON localization file translator",
      }),
    ],
    links: [
...
function RootComponent() {
  return React.createElement(RootDocument, null, React.createElement(Outlet));
}
...
function RootDocument({ children }: Readonly<{ children: React.ReactNode }>) {
  return React.createElement(
    "html",
    { lang: "en" },
    React.createElement("head", null, React.createElement(HeadContent)),
    React.createElement(
      "body",
